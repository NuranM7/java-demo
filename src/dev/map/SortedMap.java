...
public class SortedMap {
    ...
    public static void main(String[] args) {
        ...
        addPurchase("Mary Martin", jmc, 129.99D);
        addPurchase("Andy Martin", jmc, 139.99D);
        addPurchase("Mary Martin", python, 149.99D);
        addPurchase("Joe Jones", jmc, 149.99D);
        addPurchase("Bill Brown", python, 119.99D);

        addPurchase("Chuck Cheese", python, 119.99D);
        addPurchase("Davey Jones", jmc, 139.99D);
        addPurchase("Eva East", python, 139.99D);
        addPurchase("Fred Forker", jmc, 139.99D);
        addPurchase("Greg Brady", python, 129.99D);
...
//            nextEntry = reversed.higherEntry(nextDate);
